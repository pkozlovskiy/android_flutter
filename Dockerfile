...
ENV PATH="$PATH:$PWD/android-sdk-linux/platform-tools/:${ANDROID_HOME}/emulator"
...
echo y | ${ANDROID_HOME}/tools/bin/sdkmanager "platforms;android-${ANDROID_COMPILE_SDK}" "build-tools;${ANDROID_BUILD_TOOLS}" "extras;google;m2repository" "extras;android;m2repository" "emulator" && \
echo y | ${ANDROID_HOME}/tools/bin/sdkmanager "platforms;android-28" "build-tools;28.0.3" "extras;google;m2repository" "extras;android;m2repository"  "emulator"
